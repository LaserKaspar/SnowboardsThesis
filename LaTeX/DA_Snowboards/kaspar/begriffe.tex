...
Virtual-Reality bezeichnet Bilder und Töne, die von einem Computer erzeugt werden und dem Benutzer, der mithilfe von Sensoren mit ihnen interagieren kann, fast real erscheinen\cite{_oxford_dict}. Sie ist trotz anderer Anwendungsbereiche dank der Immersion und Interaktionsmöglichkeiten, die sie bietet, besonders in der Gaming-Industrie relevant geworden\cite{_bitkom_vr}. Spielenden können neue Erlebnisse geboten werden, welche wiederum eigene Game-Design-Fragen aufwerfen, die es zu beantworten gilt.
