...
\addbibresource{buketits/b_literatur.bib}  % Datei(en) mit der Bibliothek (.bib) für das Quellenverzeichnis 
\addbibresource{kaspar/k_literatur.bib}  % Datei(en) mit der Bibliothek (.bib) für das Quellenverzeichnis 
\addbibresource{wehinger/w_literatur.bib}  % Datei(en) mit der Bibliothek (.bib) für das Quellenverzeichnis 
\addbibresource{memic/m_literatur.bib}  % Datei(en) mit der Bibliothek (.bib) für das Quellenverzeichnis 
...
\include{kurzfassung}   % vom Team gemeinsam zu verfassen
...
\include {buketits/einleitung}
\include {buketits/kapitel1}
\include {buketits/kapitel2}
\include {buketits/kapitel3}
\include {buketits/kapitel4}
...
%%%Anhang
\appendix
\include{anhang_projektdokumentation}	    % Projektdokumentation
\include{anhang_kooperationsvereinbarung}	% Kooperationsvereinbarung
\include{anhang_datentraeger}	            % Inhalt des Datenträgers
