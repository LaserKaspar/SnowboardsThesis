...
\trennseite{Emma dein titel fehlt}{Emma Wehinger}{Titel + Alexander Hager}{Mediendesign - Gamedesign}
\include {wehinger/kapitel1}
\include {wehinger/kapitel2}
\include {wehinger/kapitel3}

\trennseite{Performance-Optimierung von 3D Assets in VR-Spielen}{Ian Memic}{Titel + Alexander Hager}{Mediendesign - Gamedesign}
