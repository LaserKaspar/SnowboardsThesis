...
Ein Beispiel dafür wäre eine Schiebetür, die normalerweise ein unbewegliches Hindernis ist, sich aber wenn nötig öffnen kann. Im Gegenteil zu einem static Collider kann ein kinematic Rigidbody jedoch Reibung an andere Objekte weitergeben und "`weckt"' andere Rigidbodies bei Kontakt auf.
